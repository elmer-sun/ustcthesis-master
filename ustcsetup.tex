...
\ustcsetup{
  title                = {中国科学技术大学\\交错磁体的对称性分析},
  title*               = {Symmetry analysis for Altermagnit},
  author               = {孙若尧},
  author*              = {Sun Ruoyao},
  speciality           = {理论物理},
  speciality*          = {Theoretical Physics},
  supervisor           = {曾华凌~教授, 刘军伟~教授},
  supervisor*          = {Prof. Zeng Hualing, Prof. Liu Junwei},
  ...
  student-id           = {PB22000117},  % 学号，本科生需要填写
  %
